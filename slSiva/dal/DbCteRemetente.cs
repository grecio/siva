...
namespace DAL
{
    public class DbCteRemetente : IDisposable
    {
                                            ...
                                            DateTime? pDtInicioIntervalo, DateTime? pDtFinalIntervalo, decimal? pCdMunicipio)
        {
            using (OracleConnection cnn = new OracleConnection(Properties.Settings.Default.ConnectionString))
            {
                ...
                return cnn.Query<CteRemetente>("ADM_OBJETOS.CTEPKG_CONHECIMENTO_TRANSPORTE.SP_CONSULTA_CTE_REM", param: parameters, commandType: CommandType.StoredProcedure);                
            }
        }     
