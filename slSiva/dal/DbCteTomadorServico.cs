...
namespace DAL
{
    public class DbCteTomadorServico : IDisposable
    {
                                            ...
                                            DateTime? pDtInicioIntervalo, DateTime? pDtFinalIntervalo, decimal? pCdMunicipio)
        {
            using (OracleConnection cnn = new OracleConnection(Properties.Settings.Default.ConnectionString))
            {
                ...
                return cnn.Query<CteTomadorServico>("ADM_OBJETOS.CTEPKG_CONHECIMENTO_TRANSPORTE.SP_CONSULTA_CTE_TOM_SERV", param: parameters, commandType: CommandType.StoredProcedure);                
            }
        }     
