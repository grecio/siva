...
namespace DAL
{
    public class DbCteEmitente : IDisposable
    {
                                            ...
                                            DateTime? pDtInicioIntervalo, DateTime? pDtFinalIntervalo, decimal? pCdMunicipio)
        {
            using (OracleConnection cnn = new OracleConnection(Properties.Settings.Default.ConnectionString))
            {
                ...
                return cnn.Query<CteEmitente>("ADM_OBJETOS.CTEPKG_CONHECIMENTO_TRANSPORTE.SP_CONSULTA_CTE_EMIT", param: parameters, commandType: CommandType.StoredProcedure);                
            }
        }     
